...
@media (prefers-reduced-motion: reduce){ .lp-demo{display:none;} .lp-demo-static{display:block;} }`,
    ...
    {
        id: 36,
        title: 'A Public, In-App Learning Hub \u2014 Learn From Our Bugs, Fixes, and Story (Reachable From Every Page)',
        category: 'UX / Transparency',
        status: 'Shipped',
        role: 'Product',
        effort: '45 min',
        summary: 'Made the project engineering journey openly reachable inside the app. The Learning Hub (every bug, its root cause, its fix, and the lesson, plus five role perspectives) already existed as a page but had NO way to reach it from the app. Added a floating button on every page that opens it, and reframed the intro from a dry journey line into a warm invitation to learn from our mistakes and reuse the patterns.',
        motivation: 'The owner wanted the opposite of hidden marketing: anyone who visits should be able to learn how the tool hit problems and overcame them, borrow those patterns for their own projects, and even turn a debugging story into a strong interview answer. A tool that hides its scars is just a brochure; one that shows them gives knowledge away freely. But the honest write-ups were effectively invisible because nothing in the app linked to them.',
        solution: 'Added a bottom-left floating action button (.story-fab, labelled Learn from our mistakes) that appears on every page and opens learning-hub/INDEX.html in a new tab, mirroring the existing Help and Tour floaters but placed on the opposite side so it never collides with them. Rewrote the Hub header and overview into a plain-spoken invitation (learn from the ups and downs, borrow a fix, tell your own story in interviews) and added a clear feedback path that stays true to the no-database promise: suggestions go to public GitHub Issues, not a comment box that would need a server. No backend, no tracking, no new data collected.',
        codeExample: `<!-- Every-page floater (index.html) -->\n<a id="storyFab" class="story-fab" href="learning-hub/INDEX.html" target="_blank" rel="noopener">\n  <span class="story-fab-ico">\uD83D\uDCD6</span><span class="story-fab-label">Learn from our mistakes</span>\n</a>\n\n// Feedback that needs no database:\n// Idea or better approach? -> open a public GitHub Issue (no comment backend).`,
        lesson: 'Transparency only helps people if they can find it. Great documentation with no entry point is invisible documentation. Two cheap moves unlock huge value: give it a persistent, low-friction doorway (a floater on every page), and frame it as an invitation rather than a showcase so visitors feel welcomed to learn, not sold to. And you can invite feedback without betraying your principles: public Issues give you a comment channel with zero database and zero tracking.',
        impact: 'High \u2014 turns a hidden archive into a living, public teaching resource and a differentiator: visitors learn real debugging, reuse patterns, and prepare interview stories, while the owner keeps the privacy-first, backendless contract fully intact.' 
    }
];
